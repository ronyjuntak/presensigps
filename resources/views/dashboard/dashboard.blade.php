    ...
    <div id="rekappresensi">
        ...
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:3px; z-index:999">{{ $rekappresensi->jmlhadir }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:3px; z-index:999">{{ $rekappresensi->jmlizin }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:3px; z-index:999">{{ $rekappresensi->jmlsakit }}</span>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                        <span class="badge bg-danger" style="position: absolute; top:3px; right:3px; z-index:999">{{ $rekappresensi->jmlterlambat }}</span>
                    ...
                    <li>
                        <div class="item">
                            ...
                            <div class="in">
                                ...
                                <span class="badge {{ $d->jam_in < "07:15" ? "bg-success":"bg-danger" }}" style="margin-right: 5px" >
                                    {{ $d->jam_in }}
                                </span>
                            </div>
                            <div class="out">
                                <span class="badge {{ $d->jam_out < 'jam_pulang' ? "bg-success":"bg-danger" }}">
                                    {{ $d->jam_out }}
                                </span>
                            </div>
                        </div>
