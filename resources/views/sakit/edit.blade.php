...
<div class="appHeader bg-primary text-light">
    ...
    <div class="pageTitle">Edit Form Sakit</div>
    <div class="right"></div>
</div>
@endsection
@section('content')
    ...
    <div class="col">
        <form method="POST" action="/izinsakit/{{ $dataizin->kode_izin }}/update" id="frmizin" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="text" id="tgl_izin_dari" value="{{ $dataizin->tgl_izin_dari }}" name="tgl_izin_dari" autocomplete="off" class="form-control datepicker" placeholder="Dari">
            </div>
            <div class="form-group">
                <input type="text" id="tgl_izin_sampai" value="{{ $dataizin->tgl_izin_sampai }}" name="tgl_izin_sampai" autocomplete="off" class="form-control datepicker" placeholder="Sampai">
            </div>
            <div class="form-group">
                ...
                <label for="fileuploadInput">
                    <span>
                        <strong>
                            ...
                            <i>Tap to Upload Surat Izin Dokter/Bidan</i>
                        </strong>
                    </span>
                </label>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        //                 Swal.fire({
        //                 title: 'Oops!',
        //                 text: 'Anda Sudah Melakukan Pengajuan Izin!',
        //                 icon: 'warning'
        //                 }).then((result) => {
        //                     $("#tgl_izin").val("");
        //                 });
